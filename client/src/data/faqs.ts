...
export const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Our teams primarily use Figma and FigJam for product design and collaboration, supported by the right prototyping, research, analytics, and development tools for each engagement.",
  },
  {
    question: "Do you provide UX audits or redesigns for existing products?",
    answer: "Yes. We review existing products for usability, accessibility, visual consistency, and conversion opportunities, then turn the findings into prioritized recommendations or a complete evidence-led redesign.",
  },
];
